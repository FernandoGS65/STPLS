    ...
    function renderPartidosTab() {
        ...
        loadAllMatches().then(function(matches) {
            ...
            if (n > 0) {
                ...
                html += '<div class="arb-summary-header">';
                html += '<div class="arb-summary-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 19V6l12-3v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="15" r="3"/></svg></div>';
                html += '<div class="arb-summary-title-group">';
                html += '<span class="arb-summary-title">Resumen por Partido</span>';
                html += '<span class="arb-summary-subtitle">' + n + ' partido' + (n > 1 ? 's' : '') + ' arbitrado' + (n > 1 ? 's' : '') + '</span>';
                html += '</div>';
                html += '</div>';
                html += '<div class="arb-summary-divider"></div>';
                html += '<div class="arb-summary-grid">';
                html += '<div class="arb-summary-item">';
                html += '<div class="arb-summary-icon-circle arb-summary-icon--total"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9h6M9 12h6M9 15h4"/></svg></div>';
                html += '<span class="arb-summary-val">' + avgTotal + '</span>';
                html += '<span class="arb-summary-label">Total</span>';
                html += '</div>';
                html += '<div class="arb-summary-item">';
                html += '<div class="arb-summary-icon-circle arb-summary-icon--yc"><svg viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="4" width="16" height="16" rx="2"/></svg></div>';
                html += '<span class="arb-summary-val arb-summary-val--yc">' + avgYellow + '</span>';
                html += '<span class="arb-summary-label">Amarillas</span>';
                html += '</div>';
                html += '<div class="arb-summary-item">';
                html += '<div class="arb-summary-icon-circle arb-summary-icon--rc"><svg viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="4" width="16" height="16" rx="2"/></svg></div>';
                html += '<span class="arb-summary-val arb-summary-val--rc">' + avgRed + '</span>';
                html += '<span class="arb-summary-label">Rojas</span>';
                html += '</div>';
                html += '<div class="arb-summary-item">';
                html += '<div class="arb-summary-icon-circle arb-summary-icon--pen"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 2a15 15 0 0 1 0 20M12 2a15 15 0 0 0 0 20M2 12h20"/></svg></div>';
                html += '<span class="arb-summary-val arb-summary-val--pen">' + avgPen + '</span>';
                html += '<span class="arb-summary-label">Penaltis</span>';
                html += '</div>';
                html += '</div>';
                html += '<div class="arb-summary-footer">';
                html += '<div class="arb-summary-stat-inline">';
                html += '<span class="arb-summary-dot arb-summary-dot--yc"></span>';
                html += '<span>' + totalYellow + ' amarillas totales</span>';
                html += '</div>';
                html += '<div class="arb-summary-stat-inline">';
                html += '<span class="arb-summary-dot arb-summary-dot--rc"></span>';
                html += '<span>' + totalRed + ' rojas totales</span>';
                html += '</div>';
                html += '<div class="arb-summary-stat-inline">';
                html += '<span class="arb-summary-dot arb-summary-dot--pen"></span>';
                html += '<span>' + totalPen + ' penaltis totales</span>';
                html += '</div>';
                html += '</div>';
                html += '</div>';
            }
